# Deploy Storybook to docs.skai.trade/ui/
...
# Configuration - Deploy to docs.skai.trade/ui/
$S3_BUCKET = "skai-trade-docs"
$S3_PATH = "ui"
$CLOUDFRONT_ID = "E7J1XOWEK55NB"
$REGION = "us-east-1"
$STORYBOOK_URL = "https://docs.skai.trade/ui/"
