 ...
 * Use this as a starting point for swap/trade pages.
 *
 * @example
 * ```tsx
 * import { SwapPageTemplate } from '@skai/ui/templates/swap-page';
 *
 * function SwapPage() {
 *   return <SwapPageTemplate />;
 * }
 * ```
 */
...
interface SwapPageTemplateProps {
  /** From token */
  fromToken?: Token;
  /** To token */
  toToken?: Token;
  ...
  /** On token switch */
  onSwitchTokens?: () => void;
  /** On from amount change */
  onFromAmountChange?: (value: string) => void;
  /** On to amount change */
  onToAmountChange?: (value: string) => void;
  /** On from token select */
...
const SwapPageTemplate: React.FC<SwapPageTemplateProps> = ({
  ...
  toToken = { symbol: "skaiUSD", name: "USD", balance: "0.00" },
  fromAmount = "",
  toAmount = "",
  exchangeRate = "1 ETH = 2,500 skaiUSD",
  gasEstimate = "~$2.50",
  slippage = 0.5,
  isLoading = false,
  buttonText = "Swap",
      ...
      <div className="rounded-[24px] border border-[#123F3C] bg-[#122524] p-6 shadow-[0px_8px_24px_rgba(0,0,0,0.16)]">
        ...
        <button
          ...
          className={cn(
            ...
            "bg-[#56C7F3] text-[#001615] hover:bg-[#2DEDAD]",
