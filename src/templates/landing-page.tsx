    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl space-y-8 text-center">
        ...
        >
          ...
          <div className="group relative">
            <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-[#2DEDAD] to-[#56C7F3] opacity-50 blur transition duration-300 group-hover:opacity-75" />
            <Button
              type="submit"
              className="relative h-14 w-full bg-gradient-to-r from-[#2DEDAD] to-[#56C7F3] text-xl font-bold text-black transition-all duration-300 hover:scale-[1.02] hover:opacity-90"
              disabled={isLoading}
            >
