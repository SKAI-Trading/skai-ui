...
const ScrollingTicker = React.forwardRef<HTMLDivElement, ScrollingTickerProps>(
  (
    ...
    const renderItems = (key: string) => (
      <div
        // Gap is applied via inline style — a dynamic `gap-[${gap}px]` class
        // can't be generated by Tailwind's JIT at build time, so it would be a
        // no-op (dead class) here.
    ...
    return (
      ...
      >
        ...
        {/* Scrolling content — play state is driven by the inline
            animationPlayState below; no Tailwind class needed. */}
        <div
          ref={containerRef}
          className="flex"
          style={{
