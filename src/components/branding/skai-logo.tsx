...
const SkaiLogoComposedShort: React.FC<{
  ...
  >
    ...
    {/* "Skai" wordmark — translated to (40, 7.7). x=40 sets the horizontal gap
        ...
        an earlier 3px gap read as "crammed" in feedback. y=7.7 vertically
        centers the wordmark in the 32px viewBox: the letterforms run ~16.6px
        from cap line to baseline (ignoring the S/a overshoot), so centering is
        (32 - 16.6) / 2 ≈ 7.7. The previous 3.12 sat the text ~4.5px too high.
        Being inside the viewBox, this stays centered at every render size.
        Inner viewBox widened to 81×32 and outer frame to 90px to fit. */}
    <g transform="translate(40 7.7)">
      <path
