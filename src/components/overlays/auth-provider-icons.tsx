...
/** Sky Blue 300 — the sign-in frame draws the Google mark in one flat accent. */
...
/**
 * The sign-in frames that add the wallet row (10734:74595 / 10734:74426 and
 * their in-context 1440/768/375 copies) draw the full-colour G on a Green Coal
 * 300 button. Same geometry as `GoogleIcon`; only the fills differ.
 */
export const GoogleBrandIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
    <path
      d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
      fill="#4285F4"
