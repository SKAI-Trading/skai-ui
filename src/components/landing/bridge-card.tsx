...
const TOKENS = ["USDC", "ETH", "WETH"] as const;
...
const BridgeCard = React.forwardRef<HTMLDivElement, BridgeCardProps>(
  (
    ...
    const [selectedToken, setSelectedToken] = React.useState<Token>("USDC");
        ...
        {!hasBalance && (
          <div className="flex items-start gap-[8px] bg-[#001615]/40 rounded-lg px-[12px] py-[10px]">
            ...
            <p className="font-['Manrope',sans-serif] font-normal text-[12px] leading-[16px] text-[#95A09F]">
              Deposit {selectedToken} to start bridging across chains. Earn <span className="text-[#2DEDAD] font-medium">1 SKAI Point per $1 USDC</span> deposited.
            </p>
          </div>
        )}
