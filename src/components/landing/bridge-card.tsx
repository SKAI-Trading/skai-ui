  ...
  (
    ...
    return (
      ...
      >
        ...
        {/* Chain preview */}
        <div className="flex items-center gap-[8px]">
          <div className="flex-1 flex flex-col gap-[4px] bg-[#001615]/50 rounded-lg px-[14px] py-[12px] border border-[#95A09F]/15">
          ...
          <div aria-hidden="true" className="w-8 h-8 rounded-full bg-[#001615]/50 border border-[#95A09F]/15 flex items-center justify-center flex-shrink-0">
        ...
        {!hasBalance && (
          <div className="flex items-start gap-[8px] bg-[#001615]/40 rounded-lg px-[12px] py-[10px]">
            ...
            <p className="font-['Manrope',sans-serif] font-normal text-[12px] leading-[16px] text-[#95A09F]">
              Deposit USDC to start bridging across chains. Earn <span className="text-[#2DEDAD] font-medium">1 SKAI Point per $1 USDC</span> deposited.
            </p>
          </div>
        )}
        ...
        >
          {hasBalance ? "Bridge on SKAI Wallet" : "Deposit & Start Bridging"}
