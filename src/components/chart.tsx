 ...
 * Chart Components
 *
 * Wrapper around Recharts for consistent chart styling.
 * Provides theming and configuration context.
 *
 * @example
 * ```tsx
 * import { ChartContainer, ChartTooltip, ChartTooltipContent } from '@skai/ui';
...
// Helper function for getting payload config
