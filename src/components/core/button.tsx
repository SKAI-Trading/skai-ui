...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
const skaiButtonVariants = cva(
  ...
  "inline-flex items-center justify-center font-['Manrope'] font-normal tracking-[-0.04em] transition-all duration-200 motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      skaiType: {
        ...
        primary:
          "bg-[#56C7F3] text-[#001615] hover:bg-[#2DEDAD] focus-visible:ring-[#2DEDAD]",
        ...
        link: "bg-transparent text-[#2DEDAD] hover:text-[#56C7F3] underline underline-offset-4",
      },
