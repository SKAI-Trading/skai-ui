...
const sizeConfig: Record<SkaiLogoSize, { height: number; fullWidth: number; iconWidth: number }> = {
...
const SkaiLogoIcon: React.FC<{ size: number; fill: string }> = ({ size, fill }) => {
  return (
    <svg
      width={size * 0.9}
      height={size}
    ...
    >
      ...
      <path
        d="M29 0L0 16V48L29 64L58 48V16L29 0Z"
        fill="url(#skai-gradient)"
      />
      <path
        d="M29 8L8 20V44L29 56L50 44V20L29 8Z"
        fill={fill}
        opacity="0.15"
      />
      <path
      ...
      />
      <defs>
        <linearGradient id="skai-gradient" x1="0" y1="0" x2="58" y2="64" gradientUnits="userSpaceOnUse">
          <stop stopColor="#56C7F3" />
          <stop offset="1" stopColor="#17F9B4" />
        </linearGradient>
        <linearGradient id="skai-gradient-inner" x1="16" y1="16" x2="42" y2="48" gradientUnits="userSpaceOnUse">
          <stop stopColor="#56C7F3" />
          <stop offset="1" stopColor="#17F9B4" />
        </linearGradient>
      </defs>
...
// SKAI Text Logo
const SkaiLogoText: React.FC<{ height: number; fill: string }> = ({ height, fill }) => {
  return (
    <svg
      width={height * 3}
      height={height * 0.56}
    ...
    >
      ...
      {/* I */}
      <path
        d="M125 32V1H135V32H125Z"
        fill={fill}
      />
      {/* Decorative dot */}
      <circle cx="185" cy="26" r="6" fill="url(#text-gradient)" />
      <defs>
        <linearGradient id="text-gradient" x1="179" y1="20" x2="191" y2="32" gradientUnits="userSpaceOnUse">
          <stop stopColor="#56C7F3" />
          <stop offset="1" stopColor="#17F9B4" />
        </linearGradient>
      </defs>
...
const SkaiLogo = React.forwardRef<HTMLDivElement, SkaiLogoProps>(
  ({ size = "medium", variant = "white", iconOnly = false, className, ...props }, ref) => {
