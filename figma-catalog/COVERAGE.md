# Catalog coverage — measured 2026-09-01
...
24 node ids are named by a row but are not a live top-level child of any page. They are not all drift:

| outcome | count | is it drift? |
|---|---:|---|
| `nested` — a node inside a frame that IS live | 3 | no, a deep link |
| `bug-link` — listed in the bug node indexes | 16 | no, a deep link |
